...
export default function LicensingSection() {
  const licensingCards = [
    {
      title: "Heavy Weaponry & Artillery Systems: ",
      description: "Production and assembly of cannons, mobile guns, rocket launchers, torpedo tubes, and heavy machine guns.",
      icon: (
    ...
    {
      title: "Small Arms & Tactical Firearms: ",
      description: "Handguns, revolvers, assault rifles, and light machine guns for military, law enforcement, shooting sports, hunting, and self-defense purposes.",
      icon: (
    ...
    {
      title: "Ammunition & Specialized Equipment: ",
      description: "Military-grade munitions, gas ammunition, airguns, and specialized cartridge.",
      icon: (
    ...
    {
      title: "Tactical Explosive Devices: ",
      description: "Fabrication and handling of bombs, grenades, torpedoes, mines, and rockets.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16">
          <g fill="#fff">
